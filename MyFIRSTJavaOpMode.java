...
@TeleOp(name = "TeleReal", group = "TeleOp")
public class MyFIRSTJavaOpMode extends LinearOpMode {

    private DcMotor fR, fL, bR, bL, vLift, hLift; //front right, front left, back right, back left
    private Servo foun1, claw;
    double joyScale = 0.5; //power limit
    ...
    public void runOpMode () {
        ...
        hLift.setDirection(DcMotor.Direction.FORWARD);
        vLift.setDirection(DcMotor.Direction.FORWARD);
       ...
       /* fL.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        ...
        while (!isStopRequested()) {
            ...
            flPower = Math.max(-motorMax, Math.min(flPower, motorMax));
